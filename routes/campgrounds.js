...
router.get("/", async (req, res) => {
  ...
  try {
    ...
    console.error("/campgrounds failed DB find", err);
...
router.get("/:id", async (req, res) => {
  try {
    ...
    req.flash(
      "error",
      "I can't find that campground ID to show you. Please try again."
    );
    res.redirect("/campgrounds");
  }
});
...
router.get(
  ...
  async (req, res) => {
    try {
      ...
      req.flash(
        "error",
        "I can't find that campground ID for you to edit. Please try again."
      );
...
router.put("/:id", middleware.checkCampgroundOwnership, async (req, res) => {
  try {
    ...
    req.flash(
      "error",
      "There was a problem saving your edits. Please try again"
    );
    res.redirect("/campgrounds");
  }
});
