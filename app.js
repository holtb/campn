...
if (environment.toLowerCase() == "development") {
  console.log(
    "Development Environment Detected. Seeding database. If this is incorrect, please set NODE_ENV to 'production'"
  );
  seedDB();
} else {
  console.log(
    "Production Environment Detected. Not seeding database. If this is incorrect, please set NODE_ENV to 'development'"
  );
}
